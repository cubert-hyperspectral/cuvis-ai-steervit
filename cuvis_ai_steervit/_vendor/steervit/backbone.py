# Vendored from https://github.com/manugaurdl/SteerViT (src/steervit/backbone.py) at commit d385b7c3,
...
import types
import timm
from .crossattention import GatedCrossAttention, attn_forward_wrapper
